  ...
  ?>
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="navbar-collapse justify-content-end px-0" id="navbarNav">
                    <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                        <p class="position">   : همه کاربران سایت    </p>
    ...
    <table id="myTable" class="display table-container" dir="rtl">
        ...
        <tbody>
            ...
            ?>
                <tr>
                    <td><?php echo $rowNmuber++ ?></td>
                    <td><?php echo htmlspecialchars($user['username']); ?></td>
                    <td><?php echo htmlspecialchars($user['email']); ?></td>
                    <td>
                        <?php echo ($user['Is_admin'] == 1) ? "ادمین" : "کاربر عادی"; ?>
                    </td>
                    <td><?php echo toJalali(htmlspecialchars($user['Join_date'])); ?></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
