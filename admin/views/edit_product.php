...
<body>
  ...
  <div class="body-wrapper">
      ...
      <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="navbar-collapse justify-content-end px-0" id="navbarNav">
          <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
            <p class="position">    &#128522 محصول خود را ویرایش کنید  </p>
    ...
    <div class="d-flex justify-content-center align-items-center ">
      <form class="p-5 col-md-7 col-md-offset-5" enctype="multipart/form-data" action="/admin_update_store/<?php echo $product['id']; ?>" method="post" dir="rtl">
        ...
        <div class="mb-3">
          ...
          <input type="text" autocomplete="off" class="form-control <?php echo isset($errors['name']) ? 'is-invalid' : ''; ?>"
            id="name" name="name" value="<?php echo $product['name']; ?>">
        ...
        <div class="mb-3">
          ...
          <input type="text" autocomplete="off" class="form-control <?php echo isset($errors['short_desc']) ? 'is-invalid' : ''; ?>"
            id="short_desc" name="short_desc" value="<?php echo $product['short_desc']; ?>">
        ...
        <div class="mb-3">
          ...
          <input type="text" autocomplete="off" class="form-control <?php echo isset($errors['price']) ? 'is-invalid' : ''; ?>"
            id="price" name="price" value="<?php echo $product['price']; ?>">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control <?php echo isset($errors['size']) ? 'is-invalid' : ''; ?>"
            id="size" name="size" value="<?php echo $product['size']; ?>">
        ...
        <div class="mb-3">
          ...
          <input type="text" autocomplete="off" class="form-control <?php echo isset($errors['in_stock']) ? 'is-invalid' : ''; ?>"
            id="in_stock" name="in_stock" value="<?php echo $product['in_stock']; ?>">
        ...
        <div class="mb-3">
          ...
          <textarea rows="7" autocomplete="off" class="form-control <?php echo isset($errors['desc']) ? 'is-invalid' : ''; ?>"
            name="desc" id="text_editor"><?php echo  $product['desc']; ?></textarea>
          <?php if (isset($errors['desc'])): ?>
            <div class="invalid-feedback"><?php echo $errors['desc']; ?></div>
          <?php endif; ?>
        </div>

        <button type="submit" name="update_product" class="btn btn-primary w-100">ویرایش</button>
      </form>
    </div>
