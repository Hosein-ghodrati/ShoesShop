	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="section-header d-flex flex-wrap justify-content-between mb-4 mr-5 ml-5">
				...
				<div class="category-carousel swiper">
					<div class="swiper-wrapper">
						...
						?>
							...
							<a href="category/<?php echo $category['id']; ?>" class="nav-link category-item swiper-slide">
								<img class="img_category" src="media/<?php echo $category['image'] ?? 'default.png'; ?>"
									alt="<?php echo htmlspecialchars($category['name']); ?>">
								<h3 class="category-title text_category"><?php echo $category['name']; ?></h3>
							</a>
						<?php
						}
						?>
				...
				<?php foreach ($products as $product): ?>
					<div class="col-lg-3 col-md-6">
						<div class="single-product">
							<img class="img-fluid" style="height: 200px;" src="/media/<?php echo htmlspecialchars($product['image']); ?>" alt="<?php echo htmlspecialchars($product['name']); ?>">
							<div class="product-details">
								<h6><?php echo htmlspecialchars($product['name']); ?></h6>
								<div class="price">
									<h6><?php echo htmlspecialchars($product['price']); ?> تومان </h6>
									<?php if (!empty($product['old_price'])): ?>
										<h6 class="l-through"><?php echo htmlspecialchars($product['old_price']); ?></h6>
									<?php endif; ?>
								</div>
								<div class="prd-bottom">
									<a href="/product?id=<?php echo $product['id']; ?>" class="social-info">
					...
					<div class="col-lg-3 col-md-6">
						<div class="single-product">
							...
							<div class="product-details">
								<h6><?php echo htmlspecialchars($product['name']); ?></h6>
								<div class="price">
									<h6><?php echo number_format($product['price']); ?> تومان</h6>
									<?php if (!empty($product['old_price'])): ?>
										<h6 class="l-through"><?php echo number_format($product['old_price']); ?> تومان</h6>
									<?php endif; ?>
								</div>
								<div class="prd-bottom">
									<a href="/cart/add/<?php echo $product['id']; ?>" class="social-info">
										<span class="ti-bag"></span>
										<p class="hover-text">add to bag</p>
									</a>
									<a href="/wishlist/add/<?php echo $product['id']; ?>" class="social-info">
										<span class="lnr lnr-heart"></span>
										<p class="hover-text">Wishlist</p>
									</a>
									<a href="/compare/add/<?php echo $product['id']; ?>" class="social-info">
										<span class="lnr lnr-sync"></span>
										<p class="hover-text">compare</p>
									</a>
									<a href="/product/<?php echo $product['id']; ?>" class="social-info">
										<span class="lnr lnr-move"></span>
										<p class="hover-text">view more</p>
									</a>
								</div>
		...
		<div class="row">
			<div class="col-lg-9">
				<div class="row">
					...
					<div class="col-lg-4 col-md-4 col-sm-6 mb-20">
						<div class="single-related-product d-flex">
							<a href="#"><img src="/assetsimg/r6.jpg" alt=""></a>
							<div class="desc">
								<a href="#" class="title">Black lace Heels</a>
								<div class="price">
									<h6>$189.00</h6>
					...
					<div class="col-lg-4 col-md-4 col-sm-6 mb-20">
						<div class="single-related-product d-flex">
							<a href="#"><img src="/assetsimg/r7.jpg" alt=""></a>
							<div class="desc">
								<a href="#" class="title">Black lace Heels</a>
								<div class="price">
									<h6>$189.00</h6>
